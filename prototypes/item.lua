...
data:extend({
  create_proxy_item("wcu-proxy-lumber", "__wood-logistics__/graphics/icons/lumber.png"),
  create_proxy_item("wcu-proxy-mill", "__wood-logistics__/graphics/icons/lumber-mill.png"),
  create_proxy_item("wcu-proxy-belt", "__wood-logistics__/graphics/icons/wood-transport-belt.png"),
  create_proxy_item("wcu-proxy-wagon", "__wood-logistics__/graphics/icons/wood-cargo-wagon.png")
})
